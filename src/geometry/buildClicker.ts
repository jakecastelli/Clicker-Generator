...
export function buildClicker(
  ...
  // Switch body fit: enlarge the base cutout in XY before applying each switch's
  // rotation and position. The configured clearance is added on every side.
  let socketSized: Solid = socket;
